# flake8: noqa
"""
Django settings for jazminleonwebsite project.
...
DJANGO_ROOT = root.path('jazminleonwebsite')
...
ROOT_URLCONF = 'jazminleonwebsite.urls'
...
WSGI_APPLICATION = 'jazminleonwebsite.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///jazminleonwebsite'),
}
...
WAGTAIL_SITE_NAME = "Jazmin Leon Website"
